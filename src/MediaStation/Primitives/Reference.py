...
class Reference:
    ...
    # \return The integral part of the chunk reference as a hexadecimal integer. 
    # For instance, if the referenced chunk ID was "a123", the integer 0x123 would be returned.
    def as_int(self) -> int:
